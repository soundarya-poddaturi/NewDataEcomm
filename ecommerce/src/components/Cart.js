...
import { delItem, updateQuantity } from "../reduxtoolkit/CartSlice";
...
import { addToGuestWishlist, deleteGuestCartItem, updateGuestCartItemQuantity } from "./GuestStorageFunctions";
        ...
        <div>
          ...
          <div className="my-5 rounded-3 py-5">
            <div className="d-flex justify-content-center align-items-center flex-column">
              ...
              <div>
                {isAuthenticated ? (
                  <div className="d-flex align-items-center my-2" onClick={scrollToTop}>
                    <NavLink
                      to="/checkout"
